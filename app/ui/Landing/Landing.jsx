...
export const Landing = () => {
  return (
    <div>
      <Header />
      <div id="home" className="p-4 bg-white dark:bg-gray-900"></div>
      <section className="bg-white dark:bg-gray-900">
        <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">
              Sell or Exchange your resources <br />
              on handOver!
            </h1>
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-300">
              handOver is a platform that connects peers looking to exchange or
              sell resources, solving the challenges they face in finding
              someone with the items they need.
            </p>
      ...
      <section id="view-items" className="bg-gray-900 p-6 md:p-20">
        <h1 className="p-10 -mt-8 text-3xl font-extrabold leading-none text-center tracking-tight md:text-5xl xl:text-6xl dark:text-white">
      ...
      <footer className="bg-white dark:bg-gray-800">
        <div className="max-w-screen-xl p-4 py-6 mx-auto ">
          <div className="text-center">
            ...
            <span className="block text-sm text-center text-gray-500 dark:text-gray-400">
              Made with ❤️ by{" "}
              <a
                href="https://bento.me/amitsuthar"
                className="text-gray-50 hover:underline font-bold"
              >
                {" "}
                Amit Suthar
              </a>
            ...
            <ul className="flex justify-center mt-5 space-x-5">
              <li>
                <a
                  href="https://instagram.com/oyee._amit"
                  target="_blank"
